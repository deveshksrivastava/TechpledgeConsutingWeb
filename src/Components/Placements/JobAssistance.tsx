                    ...
                    <div className="container pb-5">
                        <div className="fea-gd-vv row ">	
                            <div className="float-lt feature-gd col-lg-10 col-sm-6">	
                                ...
                                <h1>TechPledge Interview  Preparation Kit</h1>
                                ...
                                <ul>
                                    <li>Prepare your Introduction story</li>
                                    <li>Prepare your cover letter</li>
                                    <li>Prepare your Resume</li>
                                    <li>Prepare your LinkedIn</li>
                                    <li>Get ready for common questions</li>
                                    <li>Prepare your cheat sheet</li>
                                    <li>Publish your resume</li>
                                    <li>Connect with HR Consultant</li>
                                    <li>Connect With Company HR Manager</li>
                                    <li>Get set ready</li>
                                </ul>
