          ...
          <div className="container">
            <div className="d-grid grid-col-4 footer-top-29">
              <div className="footer-list-29 footer-1">
                ...
                <ul>
                  <li>
                    <p>
                      <span className="fa fa-map-marker"></span>1st Floor, Gopal
                  ...
                  <li>
                    <a href="tel:+7-800-999-800">
                      <span className="fa fa-phone"></span> +(91)-767-6703-141
                    </a>
                  </li>
                  <li>
                    <a
                      href="mailto:info@techpledgeconsulting.com"
                      className="mail"
                    >
              ...
              <div className="footer-list-29 footer-2">
                <ul>
                  ...
                  <li>
                    <a href={`deveshprojectwork/assets/images/speciality.pdf`}>
                      Speciality{' '}
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to="/PricingPolicy">Refund-Policy</Link>
                  </li>
                  <li>
            ...
            <div className="d-grid grid-col-2 bottom-copies">
              <p className="copy-footer-29">
                © 2020. All rights reserved techpledge consulting services
              </p>
