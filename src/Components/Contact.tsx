      ...
      <section className="w3l-contacts-12" id="contact">
        <div className="contact-top pt-5">
                  ...
                  <div className="cont-add">
                    <div className="cont-add-rgt">
                      ...
                      <p className="contact-text-sub">
                        TechPledge Consulting Service Pvt. LTD 1st Floor, Gopal
                        Krishna Complex, #45/3, Residency Rd, Shanthala Nagar,
                      ...
                      <h4>Address:</h4>
                      <p className="contact-text-sub">
                        TechPledge Consulting Service LLC, 9550 forest lane
                        Dallas TX 75243 suite 462, Dallas Texas, Zip Code 75243,
                        +19294945455
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="cont-add add-3">
                    <div className="cont-add-rgt">
                      ...
                      <div className="main-social-1 mt-2">
                        <a
                          href="https://www.facebook.com/TechPledgeConsulting/"
                          className="facebook"
                        >
                          <span className="fa fa-facebook"></span>
                        </a>
                        <a
                          href="https://twitter.com/TechPledgeInfo"
                          className="twitter"
                        >
                          <span className="fa fa-twitter"></span>
                        </a>
                        <a
                          href="https://www.youtube.com/channel/UCHIORKl7PAuMhAA-uS6CEFw"
                          className="youtube"
                        >
                        ...
                        <a
                          href="https://www.linkedin.com/company/techpledge-consulting-services/"
                          className="linkedin"
                        >
          ...
          <div className="map">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.0509269720237!2d77.59974021461191!3d12.968593090857846!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae167e50651a95%3A0xe89b7930a5edac16!2sTechpledge%20Consulting%20Services!5e0!3m2!1sen!2sin!4v1602768205925!5m2!1sen!2sin"></iframe>
            {/* frameborder="0" 
                                allowfullscreen="" */}
          </div>
          {/* <!-- //map --> */}
